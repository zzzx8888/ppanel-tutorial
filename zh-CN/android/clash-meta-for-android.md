...
1. **下载应用**
   - 选择上述任一下载链接
   - 下载 <!-- FILENAME_START -->`cmfa-2.11.33-meta-universal-release.apk`<!-- FILENAME_END -->
...
> 📅 最后更新：<!-- UPDATE_TIME_START -->2026-08-22<!-- UPDATE_TIME_END --> | ⚔️ 适用版本：Clash Meta for Android <!-- VERSION_START -->v2.11.33<!-- VERSION_END -->