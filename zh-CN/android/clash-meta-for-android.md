...
1. **下载应用**
   - 选择上述任一下载链接
   - 下载 <!-- FILENAME_START -->`cmfa-2.11.24-alpha-universal-release.apk`<!-- FILENAME_END -->
...
> 📅 最后更新：<!-- UPDATE_TIME_START -->2026-03-26<!-- UPDATE_TIME_END --> | ⚔️ 适用版本：Clash Meta for Android <!-- VERSION_START -->Prerelease-alpha<!-- VERSION_END -->