...
2. **下载安装**
   - 选择合适的下载源
   - 下载 <!-- FILENAME_START -->`SFA-1.13.6-legacy-android-5-universal.apk`<!-- FILENAME_END --> 文件到设备
   - 点击文件开始安装
...
> 📅 最后更新：<!-- UPDATE_TIME_START -->2026-04-07<!-- UPDATE_TIME_END --> | 📦 适用版本：sing-box <!-- VERSION_START -->v1.13.6<!-- VERSION_END --> (SFA)
