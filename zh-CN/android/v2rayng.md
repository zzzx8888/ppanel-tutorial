...
1. **下载应用**
   - 选择上述任一下载链接
   - 下载 <!-- FILENAME_START -->`v2rayNG_2.2.1-fdroid_universal.apk`<!-- FILENAME_END --> 文件
...
> 📅 最后更新：<!-- UPDATE_TIME_START -->2026-06-01<!-- UPDATE_TIME_END --> | 📱 适用版本：v2rayNG <!-- VERSION_START -->2.2.1<!-- VERSION_END -->
