...
| 下载源 | 版本 | 说明 | 状态 |
|--------|------|------|------|
| GitHub Release | v1.13.3 | [下载链接](https://github.com/SagerNet/sing-box/releases/download/v1.13.3/SFA-1.13.3-legacy-android-5-universal.apk) | ✅ |
| 镜像加速1 (gh-proxy.org) | v1.13.3 | [下载链接](https://gh-proxy.org/https://github.com/SagerNet/sing-box/releases/download/v1.13.3/SFA-1.13.3-legacy-android-5-universal.apk) | ✅ |
| 镜像加速2 (hk.gh-proxy.org) | v1.13.3 | [下载链接](https://hk.gh-proxy.org/https://github.com/SagerNet/sing-box/releases/download/v1.13.3/SFA-1.13.3-legacy-android-5-universal.apk) | ✅ |
| 镜像加速3 (cdn.gh-proxy.org) | v1.13.3 | [下载链接](https://cdn.gh-proxy.org/https://github.com/SagerNet/sing-box/releases/download/v1.13.3/SFA-1.13.3-legacy-android-5-universal.apk) | ✅ |
...
2. **Download & Install**
   ...
   - Download <!-- FILENAME_START -->`SFA-1.13.3-legacy-android-5-universal.apk`<!-- FILENAME_END --> file to device
...
> 📅 Last Updated: <!-- UPDATE_TIME_START -->2026-03-17<!-- UPDATE_TIME_END --> | 📦 Compatible Version: sing-box <!-- VERSION_START -->v1.13.3<!-- VERSION_END --> (SFA)
