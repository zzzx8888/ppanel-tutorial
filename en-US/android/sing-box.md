...
2. **Download & Install**
   ...
   - Download <!-- FILENAME_START -->`SFA-1.13.19-legacy-android-5-universal.apk`<!-- FILENAME_END --> file to device
...
> 📅 Last Updated: <!-- UPDATE_TIME_START -->2026-08-22<!-- UPDATE_TIME_END --> | 📦 Compatible Version: sing-box <!-- VERSION_START -->v1.13.19<!-- VERSION_END --> (SFA)
