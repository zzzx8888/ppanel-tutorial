...
| 下载源 | 版本 | 说明 | 状态 |
|--------|------|------|------|
| GitHub Release | 2.2.3 | [下载链接](https://github.com/2dust/v2rayNG/releases/download/2.2.3/v2rayNG_2.2.3-fdroid_universal.apk) | ✅ |
| 镜像加速1 (gh-proxy.org) | 2.2.3 | [下载链接](https://gh-proxy.org/https://github.com/2dust/v2rayNG/releases/download/2.2.3/v2rayNG_2.2.3-fdroid_universal.apk) | ✅ |
| 镜像加速2 (hk.gh-proxy.org) | 2.2.3 | [下载链接](https://hk.gh-proxy.org/https://github.com/2dust/v2rayNG/releases/download/2.2.3/v2rayNG_2.2.3-fdroid_universal.apk) | ✅ |
| 镜像加速3 (cdn.gh-proxy.org) | 2.2.3 | [下载链接](https://cdn.gh-proxy.org/https://github.com/2dust/v2rayNG/releases/download/2.2.3/v2rayNG_2.2.3-fdroid_universal.apk) | ✅ |

<!-- DOWNLOAD_TABLE_END -->

### 📋 Version Information

- **Latest Version**: v<!-- VERSION_START -->2.2.3<!-- VERSION_END -->
- **File Size**: ~35MB
...
> 📅 Last Updated: <!-- UPDATE_TIME_START -->2026-06-04<!-- UPDATE_TIME_END --> | 🚀 Compatible Version: v2rayNG <!-- VERSION_START -->2.2.3<!-- VERSION_END -->+
