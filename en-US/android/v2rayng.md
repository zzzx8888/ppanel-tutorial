...
- **Latest Version**: v<!-- VERSION_START -->2.0.18<!-- VERSION_END -->
- **File Size**: ~35MB
...
> 📅 Last Updated: <!-- UPDATE_TIME_START -->2026-04-13<!-- UPDATE_TIME_END --> | 🚀 Compatible Version: v2rayNG <!-- VERSION_START -->2.0.18<!-- VERSION_END -->+
