...
| 下载源 | 版本 | 说明 | 状态 |
|--------|------|------|------|
| GitHub Release | mobile-2.29.3 | [下载链接](https://github.com/getsurfboard/surfboard/releases/download/mobile-2.29.3/mobile-universal-release.apk) | ✅ |
| 镜像加速1 (gh-proxy.org) | mobile-2.29.3 | [下载链接](https://gh-proxy.org/https://github.com/getsurfboard/surfboard/releases/download/mobile-2.29.3/mobile-universal-release.apk) | ✅ |
| 镜像加速2 (hk.gh-proxy.org) | mobile-2.29.3 | [下载链接](https://hk.gh-proxy.org/https://github.com/getsurfboard/surfboard/releases/download/mobile-2.29.3/mobile-universal-release.apk) | ✅ |
| 镜像加速3 (cdn.gh-proxy.org) | mobile-2.29.3 | [下载链接](https://cdn.gh-proxy.org/https://github.com/getsurfboard/surfboard/releases/download/mobile-2.29.3/mobile-universal-release.apk) | ✅ |
...
> 📅 Last Updated: <!-- UPDATE_TIME_START -->2026-04-13<!-- UPDATE_TIME_END --> | 🏄 Compatible Version: Surfboard <!-- VERSION_START -->mobile-2.29.3<!-- VERSION_END -->
