...
| 下载源 | 版本 | 说明 | 状态 |
|--------|------|------|------|
| GitHub Release | v2.5.2 | [下载链接](https://github.com/clash-verge-rev/clash-verge-rev/releases/download/v2.5.2/Clash.Verge_2.5.2_x64-setup.exe) | ✅ |
| 镜像加速1 (gh-proxy.org) | v2.5.2 | [下载链接](https://gh-proxy.org/https://github.com/clash-verge-rev/clash-verge-rev/releases/download/v2.5.2/Clash.Verge_2.5.2_x64-setup.exe) | ✅ |
| 镜像加速2 (hk.gh-proxy.org) | v2.5.2 | [下载链接](https://hk.gh-proxy.org/https://github.com/clash-verge-rev/clash-verge-rev/releases/download/v2.5.2/Clash.Verge_2.5.2_x64-setup.exe) | ✅ |
| 镜像加速3 (cdn.gh-proxy.org) | v2.5.2 | [下载链接](https://cdn.gh-proxy.org/https://github.com/clash-verge-rev/clash-verge-rev/releases/download/v2.5.2/Clash.Verge_2.5.2_x64-setup.exe) | ✅ |

<!-- DOWNLOAD_TABLE_END -->

### 📋 Version Information

- **Current Version**: <!-- VERSION_START -->v2.5.2<!-- VERSION_END -->
- **File Size**: ~80MB
...
> 📅 Last Updated: <!-- UPDATE_TIME_START -->2026-09-02<!-- UPDATE_TIME_END --> | ⚡ Compatible Version: Clash Verge <!-- VERSION_START -->v2.5.2<!-- VERSION_END -->+
