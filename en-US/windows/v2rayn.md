...
| 下载源 | 版本 | 说明 | 状态 |
|--------|------|------|------|
| GitHub Release | 7.21.3 | [下载链接](https://github.com/2dust/v2rayN/releases/download/7.21.3/v2rayN-windows-64.zip) | ✅ |
| 镜像加速1 (gh-proxy.org) | 7.21.3 | [下载链接](https://gh-proxy.org/https://github.com/2dust/v2rayN/releases/download/7.21.3/v2rayN-windows-64.zip) | ✅ |
| 镜像加速2 (hk.gh-proxy.org) | 7.21.3 | [下载链接](https://hk.gh-proxy.org/https://github.com/2dust/v2rayN/releases/download/7.21.3/v2rayN-windows-64.zip) | ✅ |
| 镜像加速3 (cdn.gh-proxy.org) | 7.21.3 | [下载链接](https://cdn.gh-proxy.org/https://github.com/2dust/v2rayN/releases/download/7.21.3/v2rayN-windows-64.zip) | ✅ |

<!-- DOWNLOAD_TABLE_END -->

### 📋 Version Information

- **Current Version**: v<!-- VERSION_START -->7.21.3<!-- VERSION_END -->
...
> 📅 Last Updated: <!-- UPDATE_TIME_START -->2026-05-20<!-- UPDATE_TIME_END --> | ⚡ Applicable Version: v2rayN <!-- VERSION_START -->7.21.3<!-- VERSION_END -->