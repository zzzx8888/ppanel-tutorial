...
|-----------|----------|----------|
| 🔥 Apple Silicon | [aarch64.dmg](<!-- LINK_ARM_START -->https://github.com/clash-verge-rev/clash-verge-rev/releases/download/v2.5.4/Clash.Verge_2.5.4_aarch64.dmg<!-- LINK_ARM_END -->) | M1/M2 Mac |
| 💻 Intel x64 | [x64.dmg](<!-- LINK_INTEL_START -->https://github.com/clash-verge-rev/clash-verge-rev/releases/download/v2.5.4/Clash.Verge_2.5.4_x64.dmg<!-- LINK_INTEL_END -->) | Intel Mac |
...
> 📅 Last Updated: <!-- UPDATE_TIME_START -->2026-09-21<!-- UPDATE_TIME_END --> | ⚔️ Applicable Version: Clash Verge <!-- VERSION_START -->v2.5.4<!-- VERSION_END -->
